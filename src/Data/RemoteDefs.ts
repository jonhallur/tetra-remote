...
const ASCII = R.map(String.fromCharCode, R.range(32, 128));
                ...
                tabs: [
                    {
                        ...
                        controls:[ 
                            ...
                            },
                            {
                                ...
                                min: 0,
                                max: 2,
                                values: ['Normal', 'Stack', 'Split'],
                                default: 0,
                                nrpn: 119
                            },
                            NAME_CHAR("Name 1", t.global.name.a, 184),
                            NAME_CHAR("Name 2", t.global.name.b, 185),
                            NAME_CHAR("Name 3", t.global.name.c, 186),
                            ...
                            NAME_CHAR("Name 11", t.global.name.k, 194),
                            NAME_CHAR("Name 12", t.global.name.l, 195),
                            NAME_CHAR("Name 13", t.global.name.m, 196),
                            NAME_CHAR("Name 14", t.global.name.n, 197),
                            NAME_CHAR("Name 15", t.global.name.o, 198),
                            NAME_CHAR("Name 16", t.global.name.p, 199),
